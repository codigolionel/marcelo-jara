  ...
  return (
    <section className="py-20 bg-[#1B2A5E] grain overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 text-center relative z-10 overflow-hidden">
        ...
        >
          Empezar es muy fácil. <em className="italic text-gold">Hablemos hoy mismo.</em>
        </motion.h2>
        <motion.div
          initial={{ opacity: 0, x: 50 }}
          whileInView={{ opacity: 1, x: 0 }}
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-3 bg-whatsapp text-whatsapp-foreground px-6 py-2.5 rounded-full text-sm font-bold tracking-wide hover:shadow-[0_10px_40px_rgb(37,211,102,0.4)] hover:-translate-y-1 transition-all duration-300"
          >
